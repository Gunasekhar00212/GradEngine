...
from backend.app.models.schemas import PageBoundary
...
class SessionStateStore:
	...
	answer_json_paths: list[str] = field(default_factory=list)
	rubric_json_path: str = ""
	reliability_prediction: dict[str, Any] = field(default_factory=dict)
	...
	def to_dict(self) -> dict[str, Any]:
		...
		return {
			...
			"answer_json_paths": self.answer_json_paths,
			"rubric_json_path": self.rubric_json_path,
			"reliability_prediction": self.reliability_prediction,
